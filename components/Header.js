...
import { SearchIcon, GlobeAltIcon, MenuAlt1Icon, MenuIcon, UserCircleIcon } from '@heroicons/react/solid';
...
function Header() {
  return (
    <div className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
      ...
      <div className="flex items-center md:border-2 rounded-full py-2 shadow md:shadow-sm">
        <input
